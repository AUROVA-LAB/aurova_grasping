...
echo_and_run cd "/gripper/src/robotiq/robotiq_modbus_rtu"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/gripper/src/robotiq/robotiq_modbus_rtu/setup.py" \
     \
    build --build-base "/gripper/build/robotiq/robotiq_modbus_rtu" \
    install \
    --root="${DESTDIR-/}" \
