...
echo_and_run cd "/gripper/src/robotiq/robotiq_2f_gripper_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/gripper/src/robotiq/robotiq_2f_gripper_control/setup.py" \
     \
    build --build-base "/gripper/build/robotiq/robotiq_2f_gripper_control" \
    install \
    --root="${DESTDIR-/}" \
