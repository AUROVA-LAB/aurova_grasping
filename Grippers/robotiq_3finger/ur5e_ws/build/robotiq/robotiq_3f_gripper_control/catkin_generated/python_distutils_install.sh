...
echo_and_run cd "/home/zalmanpc/ur5e_ws/src/robotiq/robotiq_3f_gripper_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/zalmanpc/ur5e_ws/src/robotiq/robotiq_3f_gripper_control/setup.py" \
     \
    build --build-base "/home/zalmanpc/ur5e_ws/build/robotiq/robotiq_3f_gripper_control" \
    install \
    --root="${DESTDIR-/}" \
