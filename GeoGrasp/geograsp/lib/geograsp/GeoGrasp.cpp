...
void GeoGrasp::getBestGraspingPoints(
  ...
  /*float initialPointsDistance = pcl::geometry::distance(firstInitialVector, 
    secondInitialVector);*/
  Eigen::Vector3f new_diff = firstInitialVector - secondInitialVector;
  float initialPointsDistance = new_diff.norm();
  /*float firstMinDistance = pcl::geometry::distance(firstInitialVector, 
    centroidVector);*/
  new_diff = firstInitialVector - centroidVector;
  float firstMinDistance = new_diff.norm();
  /*float secondMinDistance = pcl::geometry::distance(secondInitialVector, 
    centroidVector);*/
  new_diff = secondInitialVector - centroidVector;
  float secondMinDistance = new_diff.norm();
  ...
  for (size_t i = 0; i < firstNormalCloud->points.size(); ++i) {
    ...
    /*float firstPointSecondInitialDistance = pcl::geometry::distance(firstVector, 
      secondInitialVector);*/
    Eigen::Vector3f new_diff = firstVector - secondInitialVector;
    float firstPointSecondInitialDistance = new_diff.norm();
    /*float firstPointCentroidDistance = pcl::geometry::distance(firstVector, 
      centroidVector);*/
    new_diff = firstVector - centroidVector;
    float firstPointCentroidDistance = new_diff.norm();
    ...
    for (size_t j = 0; j < secondNormalCloud->points.size(); ++j) {
      ...
      /*float graspPointsDistance = pcl::geometry::distance(firstVector, 
        secondVector);*/
      Eigen::Vector3f new_diff = firstVector - secondVector;
      float graspPointsDistance = new_diff.norm();
      /*float secondPointFirstInitialDistance = pcl::geometry::distance(
        secondVector, firstInitialVector);*/
      new_diff = secondVector - firstInitialVector;
      float secondPointFirstInitialDistance = new_diff.norm();
      /*float secondPointCentroidDistance = pcl::geometry::distance(secondVector, 
        centroidVector);*/
      new_diff = secondVector - centroidVector;
      float secondPointCentroidDistance = new_diff.norm();
